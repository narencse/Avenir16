...
public class FullScreenImageGalleryAdapter extends PagerAdapter {
    ...
    // region Constructors
    public FullScreenImageGalleryAdapter(List<Integer> images, PaletteColorType paletteColorType) {
        mImages = images;
    ...
    public Object instantiateItem(ViewGroup container, int position) {
        ...
        imageView.setImageDrawable(container.getResources().getDrawable(image));
